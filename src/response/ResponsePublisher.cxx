...
bool ResponsePublisher::init(const std::string& name)
{
    ...
    std::cout << "mind_interfaces::msg::Response DataWriter created." << std::endl;
    return true;
}

void ResponsePublisher::PubListener::on_publication_matched(
