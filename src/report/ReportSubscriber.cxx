...
void ReportSubscriber::SubListener::on_subscription_matched(
        DataReader*,
...
void ReportSubscriber::SubListener::on_data_available(
        DataReader* reader)
{
    // Take data
